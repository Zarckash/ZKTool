...
function AdobeCleaner {
    ...
    Remove-ItemProperty -Path "HKLM:\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Run" -Name "Adobe CCXProcess"
}
...
function UpdateGPUDrivers {
    ...
    "CurrentVersion = " + $CurrentVersion | Out-File $App.LogPath -Encoding UTF8 -Append
...
function StabilityTest {
    ...
    $App.Download.DownloadFile("https://download.aida64.com/aida64extreme770.zip", ($App.FilesPath + "Aida64.zip"))
...
function CPUBenchmark {
    ...
    Write-UserOutput "Abriendo Cinebench R23"
    Start-Process ($App.FilesPath + "CinebenchR23\Cinebench.exe")
}
